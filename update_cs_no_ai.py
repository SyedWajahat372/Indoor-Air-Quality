...
public partial class DashboardPage : ContentPage
{
    ...
    // Gauge Drawables
    private readonly AQIGaugeDrawable aqiDrawable = new AQIGaugeDrawable { MaxValue = 200f };
    ...
    private async Task LoadSensorData()
    {
        try
        {
            ...
            if (data != null && data.Count > 0)
            {
                ...
                // 1. Calculate Real AQI Score from Sensor Telemetry
...
print("Completely removed PredictAirQuality and external AI API dependencies!")
